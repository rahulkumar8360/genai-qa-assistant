...
**Live demo: <https://genai-qa-assistant.onrender.com>** (free plan - if it has been idle it takes about 30 seconds to wake). The demo runs in offline mode, so its answers are quoted passages with citations rather than generated text; see [Offline mode](#offline-mode).
